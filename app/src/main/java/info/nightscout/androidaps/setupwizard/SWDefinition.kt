...
class SWDefinition @Inject constructor(
    ...
    private val screenNsClient = SWScreen(injector, R.string.nsclientinternal_title)
        ...
        .add(SWEditIntNumber(injector, 120, 1, 999999)
                 .preferenceId(R.string.key_nsclientinternal_toggle_time)
                 .updateDelay(5)
                 .label(R.string.nsclientinternal_toggle_time)
                 .comment(R.string.common_values))
        .add(SWBreak(injector))
        .add(SWEditIntNumber(injector, 30, 1, 999999)
                 .preferenceId(R.string.key_nsclientinternal_toggle_active_time)
                 .updateDelay(5)
                 .label(R.string.nsclientinternal_toggle_active_time)
                 .comment(R.string.common_values))
        .add(SWBreak(injector))
